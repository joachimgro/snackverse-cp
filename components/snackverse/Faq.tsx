...
export default function Faq() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'It\'s pretty simple, just press the "<a href="/subscribe/">join now</a>" button on our site, then select what kind of payment plan suits you and provide all the necessary details. We will then take over the process of feeding you the best tasting snacks from around the world.',
    },
    {
      ...
      <div className="max-w-90 xl:max-w-xl relative flex flex-col mx-auto">
        ...
        <div className="text-left flex flex-col space-y-4 accordion mx-auto max-w-90 md:max-w-600 w-full relative z-10">
          ...
          <div className="pt-6 flex flex-col relative z-10 fadeIn lg:pb-6" style={{ pointerEvents: "auto", transform: "translate(0px, 0px)", opacity: 1 }}>
            <a href="/faqs" className="flex flex-col rounded-full text-white px-10 py-4 xl:py-6 border-purple border-2 text-purple font-bold transition duration-300 ease-in-out hover:bg-purple hover:text-white text-20 md:text-28 lg:text-32 lg:py-6 text-center">Read all questions</a>
          </div>
        </div>
      </div>
    </div>
