        ...
        <div className="hidden lg:flex">
          <ul className="flex flex-col lg:flex-row items-center gap-y-10 lg:gap-y-0 lg:items-end gap-x-4 text-white lg:gap-x-10 font-medium text-24 lg:text-18 pb-8 md:pb-0">
            <li className="slideUp">
              <a href="https://snackverse.com/subscribe/" className="text-white relative menu-hover">Subscribe</a>
            </li>
            <li className="slideUp">
              <a href="https://snackverse.com/gift/" className="text-white relative menu-hover">Give a gift</a>
            </li>
            <li className="slideUp">
              <a href="https://snackverse.com/our-previous-boxes/" className="text-white relative menu-hover">Previous boxes</a>
            </li>
            <li className="slideUp">
              <a href="https://snackverse.com/faqs/" className="text-white relative menu-hover">FAQs</a>
            </li>
            <li className="slideUp">
              <a href="https://snackverse.com/refer-a-friend/" className="text-white relative menu-hover">Refer a friend</a>
            </li>
            <li className="flex lg:hidden slideUp">
              <a href="https://snackverse.com/my-account/" className="text-white relative menu-hover">My Account</a>
            </li>
            <li className="hidden lg:inline-flex xl:pl-4 slideUp">
              <a href="https://snackverse.com/my-account/" className="text-white hover:text-orange">
